    ...
    <div class="checkReck">
        ...
        <div class="checkReckList">
            <div class="checkReckList-table">
                ...
                <el-table-column align="center" prop="addTime" label="结账时间" width="80"></el-table-column>
               ...
               <!-- <el-table-column align="center" prop="moLing" label="抹零" width="40"></el-table-column>-->
                ...
                <el-table-column align="center" prop="orgPrice" label="项目小计金额" min-width="63"></el-table-column>
                ...
                <el-table-column align="center" prop="allprice" label="发票金额" width="60"></el-table-column>
    ...
    viewDetails(val){
      console.log(val)
        if(val.payType == 1){
            ...
            this.payType = '电子卡支付';
        }else if(val.payType == 6){
            this.payType = '券兑换';
        }else if(val.payType == 7){
            this.payType = '平';
        }
        else if(val.payType == 11){
          this.payType = '人民币';
        }
        else{
            this.payType = '';
        ...
        this.number = 1;
        this.paymentAmount = val.allprice;
    }
  },
  computed: {
    ...mapState([
